...
import com.example.soc_macmini_15.musicplayer.Model.about;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnAbout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                pindah = new Intent(MainActivity.this, about.class);
    ...
    /** Berfungsi untuk meminta pengguna memberikan izin mengakses lagu */
    ...
    /** Menyiapkan tab layout dengan viewpager di dalamnya */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_search:
                Toast.makeText(this, "Cari Lagu", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.menu_favorites:
                if (checkFlag)
                    if (mediaPlayer != null) {
                        if (favFlag) {
                            Toast.makeText(this, "Berhasil ditambahkan Favorites", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_refresh:
                Toast.makeText(this, "Menyegerakan", Toast.LENGTH_SHORT).show();
                setPagerLayout();
                break;
            case R.id.img_btn_replay:

                if (repeatFlag) {
                    Toast.makeText(this, "Replay Dihapus", Toast.LENGTH_SHORT).show();
                    mediaPlayer.setLooping(false);
                    repeatFlag = false;
                } else {
                    Toast.makeText(this, "Replay Lagu", Toast.LENGTH_SHORT).show();
            ...
            case R.id.img_btn_next:
                if (checkFlag) {
                    if (currentPosition + 1 < songList.size()) {
                        ...
                        Toast.makeText(this, "Playlist Berakhir", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(this, "Pilih Lagu", Toast.LENGTH_SHORT).show();
                }
    ...
    /** Berfungsi untuk menampilkan lagu ke pemutar musik */
    ...
    /** Berfungsi untuk mengatur kontrol sesuai lagu */
